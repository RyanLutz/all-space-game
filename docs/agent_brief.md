...
| 25 | StarField S1 (galaxy catalog + test scene) — Implemented. S2 (galactic map UI) — Implemented. S3 (galaxy_sky.gdshader + rebuild_skybox) — Implemented. S4 (nebula map wiring) — Not started. | In progress |
